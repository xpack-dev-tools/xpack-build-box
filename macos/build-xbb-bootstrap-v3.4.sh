...
# Copyright (c) 2019-2025 Liviu Ionescu.
#
...
echo
echo "$(uname) ${HOST_MACHINE} XBB bootstrap v${XBB_VERSION} build script started..."
...
echo
echo "$(uname) ${HOST_MACHINE} XBB bootstrap v${XBB_VERSION} created in \"${INSTALL_FOLDER_PATH}\""
