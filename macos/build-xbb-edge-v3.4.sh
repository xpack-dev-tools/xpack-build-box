...
# Copyright (c) 2020-2025 Liviu Ionescu.
#
...
XBB_INSTALL_FOLDER_PATH="${HOME}/.local/xbb-edge"
...
source "${helper_folder_path}/common-versions-edge-source.sh"
...
echo
echo "$(uname) ${HOST_MACHINE} XBB Edge v${XBB_VERSION} build script started..."
