...
title: xPack Build Box v5.2.2 released
seo_title: Version 5.2.2 released
description: Version 5.2,2 is a new minor release of xPack Build Box.
keywords:
  - xpack
  - xbb
  - release

date: 2024-08-01 14:15:00 +0200
...
# xPack Build Box v5.2.2 released

Version **5.2.2** is a new minor release; it upgrades Python to 3.11.4 and adds C++ support.
...
Version 5.2.2 is a new release in the 5.x **self-sustained** family,
...
XBB v5.5.5 supports building binaries for the following platforms:
...
- x64/arm64/arm GNU/Linux: Ubuntu 18.04 with **GLIBC 2.27**; this
should provide compatibility with:
  - Ubuntu 18 or later
  - Debian 10 or later
  - RedHat 8 or later
  - Fedora 29 or later
  - any other distributions using GLIBC 2.27 or higher
...
[Docker Hub](https://hub.docker.com/r/ilegeul/ubuntu)
...
ilegeul/ubuntu        amd64-18.04-xbb-v5.2.2      8e85dcfabc52   6 months ago    1.21GB
```
...
```console
REPOSITORY            TAG                         IMAGE ID       CREATED         SIZE
ilegeul/ubuntu        arm32v7-18.04-xbb-v5.2.2    c57cad6360bb   6 months ago    889MB
ilegeul/ubuntu        arm64v8-18.04-xbb-v5.2.2    f7181afc00c2   6 months ago    1.19GB
```
