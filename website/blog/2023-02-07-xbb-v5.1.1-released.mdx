...
seo_title: Version 5.1.1 released
description: Version 5.1.1 is a new minor release of xPack Build Box.
keywords:
  - xpack
  - xbb
  - release
...
Version **5.1.1** is a new minor release; it upgrades Python to 3.11.4 and adds C++ support.
