...
seo_title: Version 3.3 released
description: Version 3.3 is a new release of xPack Build Box.
keywords:
  - xpack
  - xbb
  - release
...
Version **3.3** is a new release; it updates to GCC 11.
