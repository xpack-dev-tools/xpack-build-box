...
[![CI on Push](https://github.com/xpack-dev-tools/xpack-build-box/actions/workflows/test-ci.yml/badge.svg)](https://github.com/xpack-dev-tools/xpack-build-box/actions/workflows/test-ci.yml)
...
In the `xpack-dev-tools/xpack-build-box` Git repo:
...
- https://github.com/xpack-dev-tools/xpack-build-box/issues
- https://github.com/xpack-dev-tools/xpack-build-box/pulls
...
- check https://github.com/xpack-dev-tools/xpack-build-box/actions
...
[xpack-build-box Versions](https://www.npmjs.com/package/xpack-build-box?activeTab=versions).
...
```bash
rm -rf ~/tmp/xpack-build-box-test && mkdir ~/tmp/xpack-build-box-test && cd ~/tmp/xpack-build-box-test
npm init --yes
npm install xpack-build-box@next
```
...
[GitHub Pages](https://xpack-dev-tools.github.io/xpack-build-box).
...
[GitHub Actions](https://github.com/xpack-dev-tools/xpack-build-box/actions/workflows/publish-github-pages.yml).
...
in https://xpack-dev-tools.github.io/xpack-build-box/blog/
...
Check the result at https://xpack-dev-tools.github.io/xpack-build-box/.
...
In https://github.com/xpack-dev-tools/xpack-build-box/milestones:
...
```sh
npm dist-tag ls xpack-build-box
```
...
<CodeBlock language="sh"> {
`npm dist-tag add xpack-build-box@${customField('releaseVersion')} latest
npm dist-tag ls xpack-build-box
`} </CodeBlock>
...
- npmjs.com [`xpack-build-box`](https://www.npmjs.com/package/xpack-build-box/) package
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/xpack-build-box.svg)](https://www.npmjs.com/package/xpack-build-box/)
[![npm](https://img.shields.io/npm/dm/xpack-build-box.svg)](https://www.npmjs.com/package/xpack-build-box/)
  - all releases [![npm](https://img.shields.io/npm/dt/xpack-build-box.svg)](https://www.npmjs.com/package/xpack-build-box/)
