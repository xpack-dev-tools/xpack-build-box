...
- `registry.access.redhat.com/ubi8` - GLIBC 2.28, 2019-2024 (2029), kernel 4.18 \<-- XBB v3.4 - v5.1.1
- `registry.access.redhat.com/ubi9` - GLIBC 2.34, 2022-2027 (2032), kernel 5.14
...
Starting with XBB v6.0.0 (2025), support for Ubuntu 18 was discontinued.
