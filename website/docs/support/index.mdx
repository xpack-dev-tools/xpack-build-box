...
# How to get help for the xPack Build Box
...
- Check the [GitHub Discussions](https://github.com/xpack-dev-tools/xpack-build-box/discussions) for
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/xpack-build-box/issues)
tracker and the
