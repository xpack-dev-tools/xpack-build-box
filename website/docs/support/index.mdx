...
# How to obtain help for xPack Build Box
...
- Review the [GitHub Discussions](https://github.com/xpack-dev-tools/xpack-build-box/discussions) for
similar topics
- Examine the [GitHub Issues](https://github.com/xpack-dev-tools/xpack-build-box/issues)
tracker and the
[GitHub Pull Requests](https://github.com/xpack-dev-tools/xpack-build-box/pulls)
for similar problems.
...
others, please 
utilise the [GitHub Discussions](https://github.com/xpack-dev-tools/xpack-build-box/discussions)
pages.
